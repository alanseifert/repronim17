...
wget -O ReproNimChallenge.csv https://docs.google.com/spreadsheets/d/1C71ArMZyCN6zKsDx2V4qoTttFsguOupeFuJXxLceF3A/export?format=csv

subtable="ReproNimChallenge.csv"
n=`cat $subtable | wc -l`
